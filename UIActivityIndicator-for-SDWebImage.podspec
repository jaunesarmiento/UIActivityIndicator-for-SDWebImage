Pod::Spec.new do |s|
  ...
  s.author        = { "Giacomo Saccardo" => "gsaccardo@gmail.com", "Jaune Sarmiento" => "hawnecarlo@gmail.com" }
  s.source        = { :git => "https://github.com/jaunesarmiento/UIActivityIndicator-for-SDWebImage.git", :tag => "1.3" }
  s.platform      = :ios, '5.0'
  s.source_files  = '*.{h,m}'
  s.requires_arc  = true
